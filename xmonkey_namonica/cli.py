...
def main():
    ...
    parser.add_argument("--export", type=str, help="Path to export the output as a text file", default=None)
    parser.add_argument("--simple", action="store_true", help="Print a simple list of copyrights and licenses")
    ...
    copyrights = [entry['line'] for entry in result['copyrights']]
    if args.simple:
        print("\n".join(copyrights))
        print("\nLicense Content:\n" + "\n".join(licenses))
    else:
